...
image: /assets/img/blog/confession.jpg
description: "Humorous piece on Credit Cards - getting an using them"
tags: [toastmasters]
imgSrc: "Image by Republica from [Pixabay](https://pixabay.com/en/american-express-cards-credit-89024/)"
sidebar: The Original#The speech is modified from the original by multiple comedians on [Comedy Time](https://www.youtube.com/watch?v=HWuA0dcLIdY). This speech target a very different set of audience. Hope no feelings were hurt and the changes were all for the better.
youtube: pARvc9yebhc
---
